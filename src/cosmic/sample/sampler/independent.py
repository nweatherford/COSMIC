    ...
    def binary_select(self, primary_mass, binfrac_model=0.5, **kwargs):
        ...
        #         binary_choose_low <= binary_fraction_low)
            ...
            (binaryIdx_high,) = np.where(
                ...
                raise ValueError("Line 999: You have not supplied a model or a fraction. Please choose either vanHaaften, offner23, a float, or a lambda function")

#         elif (binfrac_model_msort is not None):
#             raise ValueError(
#                 "You have not supplied a model or a fraction. Please choose either vanHaaften, offner23, a float, or a lambda function"
#             )
